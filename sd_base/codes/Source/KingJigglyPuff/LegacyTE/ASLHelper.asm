...
# 1.2: Safer accessing of event mode menu
######################################################################################
...
eventMatch:
  ori r4, r3, 0x3040  # "scSelEvent"
  lwz r3,-0x43c0(r13)
  %call (gfSceneManager__searchScene) 
  lwz r12, 0x360(r3)
  addi r12, r12, 1        # /
  lwz r3, 0x368(r3)    # \  Is it co-op for Event Match? 
  cmpwi r3, 0x1          # | Those events are different if it is!
  bne co_op_event        # /
single_event:
