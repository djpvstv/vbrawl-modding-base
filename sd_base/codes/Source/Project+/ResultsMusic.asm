...
ClassicResultsTable:
	half[128] | # Slots
		...
		0x0000, 0x0000, 0x0000, 0x0000, | # Yellow Alloy, Green Alloy, "MarioD", "BossPackun"
		0x0000, 0x0000, 0x0000, 0x0000,	| # "Rayquaza", "PorkyStatue", "Porky", "HeadRobo"
		0x0000, 0x0000, 0x0000, 0x0000, | # "Ridley", "Duon", "MetaRidley", "Taboo"
